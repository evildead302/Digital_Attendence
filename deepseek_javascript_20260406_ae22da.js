// ==================== APP.JS - ULTRA DEBUG VERSION WITH OTP & DYNAMIC USER SETTINGS ====================
(function() {
    ...
    function calculateFIFOBalance(entries, targetDate = new Date()) {
        ...
        // Apply user's annual leave limit
    ...
    async function loadBalances() {
        ...
        // Apply user limits to AL and CPL
        ...
        const alCard = document.querySelector('.balance-card:first-child');
        const slCard = document.querySelectorAll('.balance-card')[1];
        const clCard = document.querySelectorAll('.balance-card')[2];
        const cplCard = document.querySelectorAll('.balance-card')[3];
        ...
        window.addDebugLog(`Balances - AL: ${finalALBalance.toFixed(2)} (capped), SL: ${slBalance.toFixed(2)}, CL: ${clBalance.toFixed(2)}, CPL: ${finalCPLBalance.toFixed(2)}, OT: ${totalOT.toFixed(1)} (with adjustments)`, 'success');
    }
    ...
    // Load user settings from server/local storage
    async function loadUserSettings() {
        if (!appCurrentUser) return;
        
        window.addDebugLog('loadUserSettings() called', 'info');
        
        // Check if settings exist in user object
    ...
    function applyUserPermissions() {
        ...
        const otInputs = document.querySelectorAll('#singleOT, [id*="OT"], [id*="ot"]');
    ...
    window.addDebugLog('app.js: Loading complete - ULTRA DEBUG VERSION WITH OTP & DYNAMIC USER SETTINGS', 'success');
})();