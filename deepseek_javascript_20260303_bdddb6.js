// ==================== APP.JS - FIXED ADJUSTMENT COLUMNS ====================
(function() {
    ...
    async function strictOverrider(entry) {
        ...
        if (entry.is_manual_adjustment === true) {
            window.addDebugLog(`Adjustment Shield ACTIVE - preserving adjustment values: AL=${entry.al_adjustment}, CPL=${entry.cpl_adjustment}, OT=${entry.ot_adjustment}`, 'success');
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (data.success && data.entry) {
                    ...
                    window.addDebugLog(`Cloud entry loaded with adjustments: AL=${cloudEntry.al_adjustment}, CPL=${cloudEntry.cpl_adjustment}, OT=${cloudEntry.ot_adjustment}`, 'info');
        ...
        try {
            ...
            for (let i = 0; i < pendingEntries.length; i++) {
                ...
                const cleanEntry = {
                    ...
                    al_adjustment: entry.al_adjustment || 0,  // CRITICAL: Send adjustment values
                    al_expiry_date: entry.al_expiry_date || null,
                    cpl_adjustment: entry.cpl_adjustment || 0,  // CRITICAL: Send adjustment values
                    cpl_expiry_date: entry.cpl_expiry_date || null,
                    ot_adjustment: entry.ot_adjustment || 0,    // CRITICAL: Send adjustment values
