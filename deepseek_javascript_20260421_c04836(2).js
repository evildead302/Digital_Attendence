...
(function() {
    ...
    // ==================== ENHANCED PUSH SUBSCRIPTION SYNC WITH RETRY LOGIC ====================
    // Sync push subscription with server - runs on app load with retry logic
    async function syncPushSubscription(retryCount = 0) {
        ...
        if (permission !== 'granted') {
            ...
            // Store in localStorage that permission is not granted
            localStorage.setItem('push_subscription_status', 'permission_denied');
            return false;
        }
        
        // Store current subscription status in localStorage
