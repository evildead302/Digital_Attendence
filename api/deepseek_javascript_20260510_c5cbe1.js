...
// Removed all references to non-existent column 'is_manual_adjustment'
...
async function handleExportData(req, res) {
    ...
    try {
        ...
        // REMOVED: is_manual_adjustment (does not exist in schema)
...
function generateCSVFromEntries(entries, user, fromDate, toDate) {
    // REMOVED: 'Is Manual Adjustment' header
    const headers = [
        'Date',
        'Day of Week',
        'Check In',
