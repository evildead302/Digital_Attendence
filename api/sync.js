...
export default async function handler(req, res) {
    ...
    try {
        ...
        // SYNC TO CLOUD (POST) - OPTIMIZED FOR SINGLE ENTRIES
        if (req.method === 'POST' && direction === 'to') {
            ...
            // Allow up to 10 entries at once (but app.js now sends one by one)
            ...
            for (let i = 0; i < entries.length; i++) {
                ...
                try {
                    ...
                    // Check if entry exists - using a more efficient query
