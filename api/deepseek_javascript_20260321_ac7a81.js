...
export default async function handler(req, res) {
    ...
    const handlers = {
        'change-password': handleChangePassword,      // Logged-in user changing password (needs current password)
        'forgot-password': handleForgotPassword,      // Initiate password reset via OTP (forgot password flow)
        'reset-password': handleResetPassword,        // Complete password reset after OTP verification
        'reset-data': handleResetData,                // Delete all entries but keep account
        'delete-account': handleDeleteAccount         // Delete entire account
    };
...
async function handleForgotPassword(req, res) {
    ...
    try {
        ...
        try {
            ...
            const otpResponse = await fetch(`${baseUrl}/api/otp?action=generate`, {
                method: 'POST',
...
// ==================== RESET PASSWORD (After OTP verification, no auth needed) ====================
...
// ==================== RESET DATA (Clear entries only, keep account) ====================
