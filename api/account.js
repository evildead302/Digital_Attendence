...
// Only uses columns that exist in the attendance_ledger schema
...
async function handleExportData(req, res) {
    ...
    try {
        ...
        // ONLY columns that exist in the schema - removed is_manual_adjustment and sync_status
...
function generateCSVFromEntries(entries, user, fromDate, toDate) {
    // Headers matching the selected columns
    const headers = [
        'Date',
        'Day of Week',
        'Check In',
