...
// FIXED: Now uses ON CONFLICT (user_id) to ensure each user has only ONE subscription
async function handleSubscribe(req, res) {
    ...
    try {
        ...
        // CRITICAL FIX: Use UNIQUE constraint on user_id, NOT endpoint
        // This ensures each user has only ONE subscription row that gets overwritten
        await sql`
        ...
        console.log(`[Subscribe] Subscription saved/overwritten for user ${user.userId}`);
