...
async function handleLogin(req, res) {
    try {
        ...
        // Get user from database - INCLUDE SETTINGS COLUMNS
        ...
        // Return user object WITH settings
