...
export default async function handler(req, res) {
    ...
    return res.status(400).json({ 
        success: false, 
        message: 'Invalid action. Use: change-password, forgot-password, reset-password, reset-data, delete-account, update-settings, get-settings, update-alarm-settings, or get-alarm-settings' 
    });
}
