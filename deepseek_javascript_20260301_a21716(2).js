...
(function() {
    ...
    async function recalculateAllMonthEnds() {
        ...
        const decLastDay = new Date(lastYear, 12, 0);
        const decDateStr = decLastDay.toISOString().split('T')[0];
        
        await createOrUpdateMonthEndEntry(decDateStr, lastYear, 11);
    ...
    window.addDebugLog('app.js: Loading complete - All features working', 'success');
})();