        ...
        try {
            ...
            if (!subscription && vapidPublicKey) {
                ...
                try {
                    ...
                    // Validate subscription has all required properties
                    if (!subscription) {
                        throw new Error('Subscription creation returned undefined');
                    }
                    ...
                    if (!subscription.keys || !subscription.keys.p256dh || !subscription.keys.auth) {
                        window.addDebugLog('[Push] Subscription keys structure:', {
                            hasKeys: !!subscription.keys,
                            keysType: typeof subscription.keys,
                            keysValue: subscription.keys ? JSON.stringify(subscription.keys) : 'null'
                        }, 'debug');
                    ...
                    window.addDebugLog(`[Push] Has p256dh: ${!!subscription.keys.p256dh}`, 'debug');
                    window.addDebugLog(`[Push] Has auth: ${!!subscription.keys.auth}`, 'debug');
            ...
            // Before sending to server, validate subscription is complete
