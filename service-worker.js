...
self.addEventListener('push', function(event) {
    ...
    // Add snooze action for checkout notifications
...
self.addEventListener('notificationclick', function(event) {
    ...
    if (action === 'checkin' || action === 'checkout' || notificationType === 'checkin' || notificationType === 'checkout') {
        const actionType = (action === 'checkin' || notificationType === 'checkin') ? 'checkin' : 'checkout';
                ...
                .then(windowClients => {
                    ...
                    for (let client of windowClients) {
                        if (client.url === '/' && 'focus' in client) {
                            ...
                            console.log('[SW] Sent message to existing client:', actionType);
                            return;
                        }
                    }
                        ...
                        return clients.openWindow(urlToOpen).then(client => {
                            ...
                            setTimeout(() => {
                                if (client) {
                                    ...
                                    console.log('[SW] Sent message to new client:', actionType);
                                }
                            }, 2000);
                        });
                    }
