...
(function() {
            ...
            if (response.ok) {
                ...
                if (data.success) {
                    currentAlarmSettings = {
                        ...
                        checkoutTime: data.settings.checkout_time || '18:00',
    ...
    async function saveAlarmSettings() {
        ...
        // Calculate default checkout time based on template for a regular day (with OT cap)
        const defaultBaseHours = weeklyTemplate.monday.base || 8;
        const defaultOTCap = weeklyTemplate.monday.maxOT || 1;
        const [checkinHour, checkinMinute] = checkinTime.split(':').map(Number);
        let checkoutHour = checkinHour + defaultBaseHours + defaultOTCap; // Add OT for alarm schedule display
