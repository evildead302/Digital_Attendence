...
(function() {
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (data.success && data.entry) {
                    ...
                    if (cloudEntry.al_adjustment === undefined) cloudEntry.al_adjustment = 0;
                    if (cloudEntry.cpl_adjustment === undefined) cloudEntry.cpl_adjustment = 0;
                    if (cloudEntry.ot_adjustment === undefined) cloudEntry.ot_adjustment = 0;
    ...
    async function saveBalanceAdjustment() {
        ...
        // Log the entry before modification for debugging
        window.addDebugLog(`Before adjustment - Entry: ${JSON.stringify(entry)}`, 'info');
        ...
        // IMPORTANT: Initialize adjustment fields if they don't exist
        ...
        window.addDebugLog(`After adjustment - Entry: ${JSON.stringify(entry)}`, 'success');
        
        // Save using saveAndSync which will respect is_manual_adjustment shield
        await saveAndSync(entry);
