    ...
    function calculateFIFOBalance(entries, targetDate = new Date()) {
        ...
        for (const entry of sortedEntries) {
            ...
            if (alAdjustment !== 0) {
                ...
                alPackets.push(packet);
                window.addDebugLog(`Added AL adjustment packet: ${alAdjustment} on ${entry.date}`, 'info');
            ...
            if (cplAdjustment !== 0) {
                ...
                window.addDebugLog(`Added CPL adjustment packet: ${cplAdjustment} on ${entry.date}`, 'info');
            }
