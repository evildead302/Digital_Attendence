...
(function() {
    ...
    async function loadBalances() {
        ...
        // We'll need to recalc OT adjustments by scanning entries again
        ...
        for (const packet of cplPackets) {
            if (packet.amount > 0 && packet.expiryDate) {
                ...
                if (daysUntil > 0 && daysUntil <= 90) {
                    ...
                    window.addDebugLog(`CPL Expiring: ${packet.amount} days from ${packet.date}, expires ${packet.expiryDate.toISOString().split('T')[0]}, in ${daysUntil} days`, 'info');
                }
            }
        }
