...
(function() {
    ...
    // Show reset password modal - Similar style to forgot password prompt
    function showResetPasswordModal(email) {
        ...
        modalContent.innerHTML = `
            ...
            <p style="color: #666; margin-bottom: 20px; font-size: 14px;">
                ...
                <strong style="color: #667eea; word-break: break-all;">${email}</strong>
            </p>
            ...
            <div class="modal-buttons" style="display: flex; gap: 12px; margin-top: 20px;">
                ...
                <button onclick="submitNewPassword('${email}')" class="modal-save" style="flex: 1; padding: 14px; background: linear-gradient(135deg, #667eea, #764ba2); color: white; border: none; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 15px;">Reset Password</button>
            </div>
        `;
