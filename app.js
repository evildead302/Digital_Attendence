...
(function() {
    ...
    async function syncPushSubscription() {
        ...
        try {
            ...
            window.addDebugLog('[Push] Service worker ready', 'success');
            ...
            if (!subscription && vapidPublicKey) {
                ...
                try {
                    ...
                    window.addDebugLog('[Push] Application server key converted', 'debug');
                    ...
                    window.addDebugLog(`[Push] Subscription endpoint: ${subscription.endpoint.substring(0, 50)}...`, 'debug');
                } catch (subError) {
