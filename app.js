...
(function() {
    ...
    async function loadAlarmSettings() {
        ...
        // Step 1: Update offset before download - send current timezone to server
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (data.success) {
                    ...
                    // Convert checkin time from cloud UTC to local time
                    ...
                    // Convert checkout time from cloud UTC to local time
    ...
    async function saveAlarmSettings() {
        ...
        window.addDebugLog(`[Alarm] Day calculation: Day=${dayName}, Base=${baseHours}h, OT Cap=${maxOT}h, Total=${totalWorkHours}h`, 'info');
