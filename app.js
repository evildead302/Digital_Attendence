...
(function() {
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (data.success && data.entry) {
                    ...
                    window.addDebugLog(`fetchFromCloud: Cloud entry loaded with adjustments: AL=${cloudEntry.al_adjustment}, SL=${cloudEntry.sl_adjustment}, CL=${cloudEntry.cl_adjustment}, CPL=${cloudEntry.cpl_adjustment}, OT=${cloudEntry.ot_adjustment}`, 'success');
        ...
        try {
            ...
            if (data.success && data.entries) {
                ...
                for (const entry of data.entries) {
                    ...
                    // If the cloud entry doesn't have these fields, they will be undefined and we set to 0
                    // But if they exist, we preserve their values
    ...
    function calculateFIFOBalance(entries, targetDate = new Date()) {
        ...
        window.addDebugLog(`FIFO Matchmaker complete - AL: ${alBalance.toFixed(2)}, CPL: ${cplBalance.toFixed(2)}, OT Adj: ${totalOTAdjustment}, SL Adj: ${totalSLAdjustment}, CL Adj: ${totalCLAdjustment}`, 'success');
    ...
    async function loadBalances() {
        ...
        if (fifoResult.otAdjustmentTotal !== 0) {
            ...
            // Add OT adjustments to current month for simplicity
