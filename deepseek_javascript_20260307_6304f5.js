...
(function() {
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (data.success && data.entry) {
                    ...
                    window.addDebugLog(`fetchFromCloud: RAW cloud entry: ${JSON.stringify(cloudEntry)}`, 'debug');
                    ...
                    window.addDebugLog(`fetchFromCloud: Processed cloud entry with adjustments: AL=${cloudEntry.al_adjustment}, CPL=${cloudEntry.cpl_adjustment}, OT=${cloudEntry.ot_adjustment}`, 'success');
    ...
    async function loadAdjustments() {
        ...
        entries.forEach(e => {
            ...
            window.addDebugLog(`Processing table row for ${e.date}: Found al_adjustment=${alValue}, cpl_adjustment=${cplValue}, ot_adjustment=${otValue}, is_manual=${e.is_manual_adjustment}`, 'debug');
        });
        ...
        adjustments.slice(0, 20).forEach(adj => {
            ...
            window.addDebugLog(`Displaying adjustment: ${adj.date} - AL:${alValue}, CPL:${cplValue}, OT:${otValue}`, 'success');
